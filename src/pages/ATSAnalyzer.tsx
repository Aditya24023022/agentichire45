...
const ATSAnalyzer = () => {
  ...
  const { result, loading, generate } = useAIAgent({ type: "ats", successMessage: "ATS analysis complete!" });
  ...
  return (
    <FeaturePageLayout
      ...
      description="Check your resume's ATS compatibility and get improvement recommendations"
    >
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <Label className="text-foreground text-base">ATS Analysis Report</Label>
            {result && (
          ...
          <div className="min-h-[500px] p-6 rounded-xl bg-card border border-border overflow-auto">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="text-muted-foreground">Your ATS analysis will appear here</p>
              </div>
            )}
          </div>
        </div>
